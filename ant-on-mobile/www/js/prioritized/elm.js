var Elm = Elm || { Native: {} };
Elm.Adapter = Elm.Adapter || {};
Elm.Adapter.make = function (_elm) {
   "use strict";
   _elm.Adapter = _elm.Adapter || {};
   if (_elm.Adapter.values)
   return _elm.Adapter.values;
   var _op = {},
   _N = Elm.Native,
   ...
   var triggers = function () {
      ...
      state) {
         return _U.eq(input,
         "L") ? "sendLeftKeyDown" : _U.eq(input,
         "R") ? "sendRightKeyDown" : _U.eq(input,
         "Skip") ? "sendEscKeyDown" : "What should I do!?";
      });
   ...
   var triggerEvent = _P.portOut("triggerEvent",
   _P.outgoingSignal(function (v) {
      return v;
   }),
   triggers);
   _elm.Adapter.values = {_op: _op
                         ,triggers: triggers};
   return _elm.Adapter.values;
};
